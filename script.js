const questions = [
    ...
    { 
        ...
        answers: ["26.08.2024", "06.09.2023 ", "21.09.2023", "02.01.2024 "], 
        correct: 3, 
    ...
    { 
        type: "text",
        question: [
            "Всё правильно! А как насчёт такой загадки:" + "<pre> </pre>" + "Эротически звучащая сантехническая деталь" + "<pre> </pre>" + "⬇️ введи свой ответ в этот белый прямоугольник ⬇️",
        ],
        correctText: "стояк", 
    },
    {
        type: "text",
        question: "Какой ты догадистый)) Напоследок нужно что-то посложнее… Вот:" + "<pre> </pre>" + "'Ldflwfnm 25+6+20+29+18+10' "+ "<pre> </pre>" + "⬇️ введи свой ответ в этот белый прямоугольник ⬇️", 
    ...
    {
        type: "text",
        question: "Ладно, не совсем последняя. (Невозможно было не включить это в квест). Продолжи цитату Великого:" + "<pre> </pre>" + "«ведь если глубоко поразмышлять то можно, исходя из вышесказанного, решить, взвешивая все за и против, все минусы и плюсы, что вывод заключается в ответе на главный вопрос, который надо тщательно обдумать, ведь решение этой высокоинтеллектуальной загадки мироздания прост и гласит оно...»", 
        correctText: "вокзал",
    },
    {
        type: "single",
